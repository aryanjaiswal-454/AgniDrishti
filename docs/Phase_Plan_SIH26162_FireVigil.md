...
| **Companion docs** | PRD_SIH26162_FireVigil, Architecture_SIH26162_FireVigil, DataSpecification_SIH26162_FireVigil |
...
- One-time pull: FIRMS CSV for that region/window, OSM Overpass extract for that region, land-cover raster clipped to that region. Commit source inputs to `data/sample/input/` in the repo.
